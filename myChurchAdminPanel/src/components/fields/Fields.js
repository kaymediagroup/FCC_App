...
class Fields extends Component {
  ...
  displayFields(){
    ...
    return <Element parentKey={this.props.parentKey} options={options} updateAction={this.props.updateAction} class={elementClass} theKey={this.props.theKey} value={this.props.value} />
  }
